...
class Collection
{
	...
	public static function createRoot( $name, $user_id, $description ){
		include $_SERVER["DOCUMENT_ROOT"] . "/TODO-PHP-OOP/inc/connection.php";

		$sql = "INSERT INTO todo_app_collections VALUES (NULL, ?, ?, ?, CURRENT_TIMESTAMP(), NULL, NULL)";
...
// what should i return where there are not solutions
	...
	public static function rootCollection( $id ){
