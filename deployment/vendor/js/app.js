...
function createTodoClicked( arg = null ){
	if( arg !== null ){
		window.location = window.location.origin + "/TODO-PHP-OOP/views/todo.php?id_collection="+arg;
	}else{
	 window.location = window.location.origin + "/TODO-PHP-OOP/views/todo.php";
	}
}

function createLibraryClicked( arg = null ){
	if( arg !== null ){
  	window.location = window.location.origin + "/TODO-PHP-OOP/views/library.php?id_collection="+arg;
	} else{
		window.location = window.location.origin + "/TODO-PHP-OOP/views/library.php";
	}
}
