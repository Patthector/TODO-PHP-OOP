<div class = "front-page">
  <div class = "row front-page__first-block">
  ...
  <div class = "row front-page__second-block">
    <div class = "col-12 col-md-6">
      <div class = "left">
  ...
  <div class = "row front-page__third-block">
    <h3 class = "front-page__example-heading col-12">#example</h3>
    <div class = "front-page__example-svg col-12">
