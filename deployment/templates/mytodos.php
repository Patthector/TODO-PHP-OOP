				...
				<div class = "todo__collection-header">
			      ...
			      <?php
					...
					<div class = "todo__collection-body">
						...
						<div class = "todo__collection-body-category">
							...
							<ul class = "todo__collection-body-subcategory-list todo__mytodos--subcollection-list carousel">
								...
								if(count($subcollections) == 0){
									echo "<li style = \"margin:auto\">There are not subcategories available. Do you want to create a <a href = \"../views/library.php?id_collection=" . $item_collection->get__collection_id() . "\"><b>new subcategory?</b></a></li>";
								} else{
						...
						<div class = "todo__collection-body-todo">
							...
							if(count($todosCollection) == 0){
								echo "<p style = \"text-align:center\">There are not todos available. Do you want to create a <a href = \"../views/todo.php?id_collection=" . $item_collection->get__collection_id() . "\"><b>new todo?</b></a></p>";
							} else{
					...
					<div class = "todo__library-footer">
						<p>Created be <span><?php echo $user->get__username(); ?></span> on <span><?php if( !empty( $item_collection->get__collection_created_date() ) ) echo $item_collection->get__collection_created_date(); ?></span><span><?php if( !empty( $item_collection->get__collection_updated_date() ) ) echo ". Last update on " . $item_collection->get__collection_updated_date(); ?></span></p>
					</div>
				</div>
			</div>
<?php
